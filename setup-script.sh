...
storageAccount="udacitydiag1234590000"
...
echo "STEP 1 - Creating storage account udacitydiag1234590000"

az storage account create --name udacitydiag1234590000 --resource-group acdnd-c4-project --location westus --sku Standard_LRS

echo "Storage account created: udacitydiag1234590000"
